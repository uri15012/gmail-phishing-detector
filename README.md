...
**Project:** Gmail Malicious Email Scorer — Bootcamp Home Assignment
...
This project was developed as a submission for a competitive bootcamp. It demonstrates the ability to integrate multiple external APIs, implement a multi-layered security model, and build a functional, user-facing application within the Google Workspace ecosystem using Google Apps Script.
